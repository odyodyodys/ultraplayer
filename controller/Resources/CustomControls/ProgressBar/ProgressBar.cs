...
{
    /// <summary>
    /// A replacement for the default XpProgressBar control.
    /// </summary>
    [DefaultEvent("ValueChanged")]
    public class XpProgressBar : System.Windows.Forms.UserControl
    {
        ...
        public XpProgressBar()
        {
            ...
            if (!InDesignMode())
            {
                mGlowAnimation.Tick += new EventHandler(GlowAnimationTick);
        ...
        private void GlowAnimationTick(object sender, EventArgs e)
        {
            if (this.Animate)
            {
                mGlowPosition += 4;
