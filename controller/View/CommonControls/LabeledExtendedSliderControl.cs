...
{
    public partial class LabeledExtendedSliderControl : UserControl
    {
        #region Fields
        private float _min;
        private float _max;
        ...
        #region Constructors
        public LabeledExtendedSliderControl()
        {
            InitializeComponent();
        ...
        {
            ParamNameLabel.Text = _friendlyName;
            ParamMinLabel.Text = ((_min)).ToString();
            ParamMaxLabel.Text = ((_max)).ToString();
        ...
        #region Events
	        private void ParamTrackBar_Scroll(object sender, EventArgs e)
	        {
